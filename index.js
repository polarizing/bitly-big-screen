...
app.post('/gif', function(req, res) {
    ...
    expressWs.getWss().clients.forEach(client => client.send(PLAY_GIF + " " + gif_link));  
...
app.post('/change', function(req, res) {
    ...
    // res.sendStatus(200);
    // ws.send('update');
    expressWs.getWss().clients.forEach(client => client.send(CHANGE_STATE));  
